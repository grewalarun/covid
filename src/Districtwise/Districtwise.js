    ...
    return (
       ...
       <ul className="statelist">
        ...
        <thead>
          ...
          <tr key={g}>
            <td className={(f==="Unknown")||(f==="Other State")||(f==="Italians")||(f==="Evacuees")|| (f==="Foreign Evacuees") ||(f==="Other Region")   ||(f==="BSF Camp")||(f==="Airport Quarantine")||(f==="Other State")||(f==="Railway Quarantine")?"++":zone.zones.filter(a => a.district===f)[0].zone + "districtzone"}>{f}</td>
